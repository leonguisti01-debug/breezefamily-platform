...
export default function JudgeAdminLoginPage() {
  ...
  const login = () => {
    ...
    if (password === "Judge2026") {
      ...
      localStorage.setItem("judge-admin-auth", "true");

      router.push("/judge-admin");
  ...
  return (
    <main className="min-h-screen bg-black text-white flex items-center justify-center px-6">
      ...
      <div className="w-full max-w-md rounded-[40px] border border-white/10 bg-white/5 backdrop-blur-xl p-10">
        ...
        <button
          onClick={login}
          className="w-full mt-6 px-5 py-4 rounded-2xl bg-yellow-500 hover:bg-yellow-400 text-black transition font-black"
        >
          LOGIN
        </button>
