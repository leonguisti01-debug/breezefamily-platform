...
export default function KidsBattlesPage() {
      ...
      battleRows
        .map((battle) => {
          ...
          return {
            ...
            judged_by: battle.judged_by,
            judged_at: battle.judged_at,
  ...
  function openBattle(
    ...
    router.push(
      `/admin/tiktok-kids/battles/${battleNumber}`
    );
  }
  ...
  return (
    ...
    >
      ...
      <div className="flex gap-4 items-center">
        ...
        <div className="w-20 h-24 md:w-24 md:h-28 rounded-2xl overflow-hidden bg-zinc-900 shrink-0">
        ...
        <div className="min-w-0 flex-1">
          ...
          <p className="text-white/30 text-[10px] font-black uppercase tracking-[2px]">
            {right
              ? "Contestant 2"
              : "Contestant 1"}
          </p>

          <h3 className="text-lg md:text-2xl font-black uppercase leading-tight mt-1">
            {contestant.full_name}
          </h3>
        ...
        {completed && (
          <div className="shrink-0">
            ...
            {winner && (
              <span className="inline-block bg-green-500 text-black px-3 py-2 rounded-full text-[10px] md:text-xs font-black uppercase">
                Through
              </span>
            )}

            {loser && (
              <span className="inline-block bg-red-500/15 text-red-400 border border-red-500/20 px-3 py-2 rounded-full text-[10px] md:text-xs font-black uppercase">
                Out
              </span>
            )}
