          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="max-w-3xl">
              ...
              <div className="mt-14 flex flex-wrap gap-6">
                ...
                <Link
                  href="/kids-edition"
                  className="px-10 py-5 rounded-2xl bg-gradient-to-r from-pink-500 to-fuchsia-600 text-white font-black text-lg md:text-xl hover:scale-105 transition"
                >
                  ENTER NOW
                </Link>
                ...
                <Link
                  href="/season-2-finale"
                  className="px-10 py-5 rounded-2xl border-2 border-cyan-300 text-cyan-300 font-black text-lg md:text-xl hover:bg-cyan-300 hover:text-black transition"
                >
                  LIVE VOTING
                </Link>
